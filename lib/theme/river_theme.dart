...
class AppPalette {
  ...
  static Color statusGlow(String level) {
    switch (level.toUpperCase()) {
      case 'SAFE':     return safeGlow;
      case 'WARNING':  return warnGlow;
      case 'SEVERE':   return severeGlow;
      case 'DANGER':   return dangerGlow;
      case 'CRITICAL': return critGlow;
...
class RiverColors extends ThemeExtension<RiverColors> {
  ...
  RiverColors copyWith({
    Color? riverNormal, Color? riverWarning, Color? riverSevere,
    Color? riverDanger, Color? riverCritical, Color? riverSurface,
    Color? riverGlow, Color? cardBg, Color? cardBgElevated, Color? chipBg,
    Color? stroke, Color? textPrimary, Color? textSecondary,
    Color? sparklineColor, Color? accent, Color? accentGlow,
    Color? metricColor, Color? navBg, Color? navActive,
    Color? navInactive, Color? scaffoldBg,
  }) => RiverColors(
