...
class RoboticTheme {
  ...
  Color get surface =>
      isDark ? RoboticColors.rdSurface : RoboticColors.rlSurface;
  Color get surface2 =>
      isDark ? RoboticColors.rdSurface2 : RoboticColors.rlSurface2;
  ...
  Color get accentGlow =>
      isDark ? RoboticColors.rdAccentGlow : RoboticColors.rlAccentGlow;
  Color get accent2 =>
      isDark ? RoboticColors.rdAccent2 : RoboticColors.rlAccent2;
  Color get accent2Glow =>
      isDark ? RoboticColors.rdAccent2Glow : RoboticColors.rlAccent2Glow;
  Color get danger => isDark ? RoboticColors.rdDanger : RoboticColors.rlDanger;
  Color get warning =>
      isDark ? RoboticColors.rdWarning : RoboticColors.rlWarning;
  Color get text => isDark ? RoboticColors.rdText : RoboticColors.rlText;
  Color get textMuted =>
      isDark ? RoboticColors.rdTextMuted : RoboticColors.rlTextMuted;
  ...
  ThemeData toThemeData() {
    ...
    return ThemeData(
      ...
      chipTheme: ChipThemeData(
        backgroundColor:
            isDark ? const Color(0xFF1C2333) : const Color(0xFFEBF0F5),
      ...
      textTheme: TextTheme(
        ...
        titleMedium: TextStyle(
            ...
            fontFamily: 'RobotoMono'),
        bodyMedium:
            TextStyle(color: rc.textSecondary, fontFamily: 'RobotoMono'),
