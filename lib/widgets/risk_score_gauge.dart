...
class RiskScoreGauge extends StatelessWidget {
  ...
  Color _colorForZone(RiskZone zone) {
    switch (zone) {
      case RiskZone.low:      return const Color(0xFF4CAF50);
      case RiskZone.moderate: return const Color(0xFFFFC107);
      case RiskZone.high:     return const Color(0xFFFF9800);
      case RiskZone.veryHigh: return const Color(0xFFFF5722);
      case RiskZone.extreme:  return const Color(0xFFE53935);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        if (label.isNotEmpty) ...[const SizedBox(height: 6), Text(label, style: const TextStyle(fontSize: 12))],
      ],
    );
  }
}
