...
ForecastSeverity _toSeverity(String raw) {
  switch (raw.toUpperCase()) {
    case 'CRITICAL':
      return ForecastSeverity.critical;
    case 'SEVERE':
      return ForecastSeverity.severe;
    case 'MODERATE':
      return ForecastSeverity.moderate;
    default:
      return ForecastSeverity.normal;
  }
}
