          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                Center(
                    child: Text('Bihar Water Resources Dept.',
                        style:
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _ToggleRow(
                            ...
                            value: _notifWarning,
                            onChanged: (v) =>
                                setState(() => _notifWarning = v)),
                        _ToggleRow(
                            t: t,
                            label: 'Heavy Rainfall Alerts',
                            icon: Icons.grain_rounded,
                            color: const Color(0xFF1976D2),
                            value: _notifRainfall,
                            onChanged: (v) =>
                                setState(() => _notifRainfall = v)),
                        _ToggleRow(
                            t: t,
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  prefixIcon: Icon(icon,
                      color:
                          enabled ? const Color(0xFF2196F3) : t.textSecondary,
                      size: 18),
                  border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(10)),
                  disabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
                    borderSide:
                        BorderSide(color: t.stroke.withValues(alpha: 0.3)),
                  ),
                  contentPadding:
                      const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                ),
