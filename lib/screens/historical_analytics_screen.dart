...
class HistoricalAnalyticsScreen extends StatefulWidget {
  ...
  @override
  State<HistoricalAnalyticsScreen> createState() =>
                    ...
                    Expanded(
                        child: _MiniKpi(
                            ...
                            value: events.isEmpty
                                ? '—'
                                : '${(events.map((e) => e.level).reduce((a, b) => a + b) / events.length).toStringAsFixed(1)}m',
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 14),
                        ..._districtRisks
                            .map((d) => _DistrictRiskRow(t: t, data: d)),
                      ],
                    ),
                  ),
                ),
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: sel
                    ? const Color(0xFF0288D1)
                    : t.stroke.withValues(alpha: 0.2)),
          ),
          child: Text(label,
              style: TextStyle(
                  color: sel ? const Color(0xFF0288D1) : t.textSecondary,
                  fontSize: 11,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(event.date.split(' ')[1],
                      style: const TextStyle(
                          color: Color(0xFFE53935), fontSize: 9)),
                ],
              ),
            ),
...
class _DistrictRiskRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = data.riskScore > 0.80
