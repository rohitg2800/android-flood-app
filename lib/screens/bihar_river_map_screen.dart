...
class _BiharRiverMapScreenState extends ConsumerState<BiharRiverMapScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final isFilterActive =
        visibleClasses != null || hideNormal || baselineFilter;
            ...
            children: [
              FlutterMap(
                ...
                children: [
                  ...
                  geoAsync.when(
                    data: (gj) =>
                        PolygonLayer(polygons: _buildPolygons(gj, distRisk)),
              ...
              Positioned(
                ...
                child: _BiharMapTopBar(
                  ...
                  onToggle: () {
                    final next =
                        isBihar ? MapViewMode.national : MapViewMode.bihar;
              ...
              if (!_showLegend)
                Positioned(
                  ...
                  child: FloatingActionButton.small(
                    ...
                    child:
                        Icon(Icons.layers_outlined, color: rc.accent, size: 20),
                  ),
                ),
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: meta.color.withValues(
                            alpha: isActive ? 1.0 : (isDimmed ? 0.2 : 0.45)),
              ...
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(
                      color: baselineColor.withValues(
                          alpha: baselineActive ? 1.0 : 0.45),
...
class _BiharMapTopBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final countLabel =
        isFiltered ? '$stationCount / $totalCount' : '$stationCount stations';
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    searchOpen ? rc.accent.withValues(alpha: 0.2) : rc.cardBg,
                borderRadius: BorderRadius.circular(10),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: isLoading
                  ...
                  : Icon(Icons.refresh_rounded, color: rc.accent, size: 18),
            ),
          ),
          const SizedBox(width: 6),
          GestureDetector(
            ...
            child: Container(
              ...
              child:
                  Icon(Icons.public_rounded, color: rc.textSecondary, size: 18),
            ),
          ),
          const SizedBox(width: 6),
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    drawerOpen ? rc.accent.withValues(alpha: 0.2) : rc.cardBg,
                borderRadius: BorderRadius.circular(10),
                border: Border.all(color: rc.stroke.withValues(alpha: 0.4)),
              ),
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintStyle:
                          TextStyle(color: rc.textSecondary, fontSize: 14),
              ...
              if (_ctrl.text.isNotEmpty)
                GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Icon(Icons.close_rounded,
                        color: rc.textSecondary, size: 16),
                  ),
                ),
            ],
          ),
