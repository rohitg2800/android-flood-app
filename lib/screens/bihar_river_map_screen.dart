      ...
      child: Row(
        ...
        children: [
          const Icon(Icons.warning_rounded,
              color: AppPalette.critical, size: 10),
          const SizedBox(width: 4),
          Text(
            critCount > 0
                ? '$critCount CRIT'
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: showStations
                    ? AppPalette.critical.withValues(alpha: 0.10)
                    : t.cardBgElevated,
                borderRadius: BorderRadius.circular(10),
                border: Border.all(
                    color: showStations
                ...
                Expanded(
                  child: SliderTheme(
                    data: SliderThemeData(
                      ...
                      activeTrackColor: AppPalette.critical,
                      inactiveTrackColor:
                          AppPalette.critical.withValues(alpha: 0.2),
                      thumbColor: AppPalette.critical,
                      overlayColor:
                          AppPalette.critical.withValues(alpha: 0.15),
                    ),
                    child: Slider(
