...
class _CityDetailScreenState extends ConsumerState<CityDetailScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final predAsync =
        ref.watch(biharPredictionProvider((data.stationId, city)));
      ...
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(16, 14, 16, 0),
              child: _GaugeCard(fillPct: fillPct, pctVal: pctVal, rc: rc, t: t),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          SliverToBoxAdapter(
            child: Padding(
              padding: const EdgeInsets.fromLTRB(16, 14, 16, 0),
              child: _QuickActions(cityName: city, riskLevel: riskLevel, t: t),
            ),
          ),
          SliverToBoxAdapter(
            child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                      color:
                          pred.fromBackend ? AppPalette.safe : AppPalette.gold,
                      fontSize: 10,
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: riskColor.withValues(alpha: 0.55), width: 1.5),
                      boxShadow: [
                        BoxShadow(
...
class _StatsGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final stats = [
      _S('Current Level', '${currentLevel.toStringAsFixed(2)} m',
      ...
      _S('Fill %', '${fillPct.toStringAsFixed(1)}%', Icons.show_chart_rounded,
          t.accent),
      _S('State', data.state ?? '—', Icons.location_on_outlined,
          t.textSecondary),
    ];
                    ...
                    children: [
                      ...
                      FractionallySizedBox(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                                colors: [rc, rc.withValues(alpha: 0.7)]),
                            borderRadius: BorderRadius.circular(10),
                          ),
                        ),
                      ),
