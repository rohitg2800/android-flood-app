                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border:
                                    Border.all(color: const Color(0x407E57C2)),
                              ),
                              child: const Center(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      'Trained on 18 Bihar Stations — 792K Real Data Points',
                                      style: TextStyle(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _FeatureBar(
                            t: t,
                            label: 'Level % of Warning',
                            pct: 0.91,
                            color: const Color(0xFF0288D1)),
                        _FeatureBar(
                            t: t,
                            label: 'Upstream Level Norm',
                            pct: 0.84,
                            color: const Color(0xFF0288D1)),
                        _FeatureBar(
                            t: t,
                        ...
                        _FeatureBar(
                            t: t,
                            label: 'Embankment Status',
                            pct: 0.37,
                            color: const Color(0xFF0288D1)),
                        _FeatureBar(
                            t: t,
                            label: 'Dam Release (upstream)',
                            pct: 0.31,
                            color: const Color(0xFF0288D1)),
                      ],
                    ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 14),
                        _InfoRow(
                            t: t, label: 'Training Records', value: '1,24,800'),
                        _InfoRow(
                            t: t, label: 'Validation Records', value: '26,400'),
                        _InfoRow(t: t, label: 'Test Records', value: '13,200'),
                        _InfoRow(
                            t: t, label: 'Date Range', value: '2005 – 2024'),
                        _InfoRow(
                            t: t,
                            label: 'Stations Covered',
                            value: '68 CWC + BeFIQR'),
                        _InfoRow(
                            t: t, label: 'Last Retrained', value: 'Mar 2025'),
                        _InfoRow(
                            t: t,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _SourceChip(
                            label: 'BWRD — Bihar Water Resources Dept.'),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _ChangelogRow(
                            ...
                            date: 'Jun 2026',
                            note:
                                'Bihar-RF-v2 — trained on 792K real gauge data, SMOTE balanced, deployed on Railway'),
                        _ChangelogRow(
                            t: t,
                            version: 'v2.5',
                            date: 'Jun 2026',
                            note:
                                'BiLSTM models for 65+ Bihar stations, physics fallback removed'),
                        _ChangelogRow(
                            t: t,
                            version: 'v2.4',
                            date: 'Mar 2025',
                            note:
                                'BeFIQR station integration, improved monsoon recall'),
                        _ChangelogRow(
                            t: t,
                            version: 'v2.3',
                            date: 'Oct 2024',
                            note: 'SAR satellite feature added, F1 +1.2%'),
                        _ChangelogRow(
                            t: t,
                            version: 'v2.2',
                            date: 'Apr 2024',
                            note: 'Ensemble weight tuning, AUC-ROC 0.97→0.978'),
                        _ChangelogRow(
                            t: t,
                            version: 'v2.1',
                            date: 'Nov 2023',
                            note: 'Dam release upstream feature added'),
                        _ChangelogRow(
                            t: t,
                            version: 'v2.0',
                            date: 'Jun 2023',
                            note:
                                'XGBoost+RF ensemble replacing standalone RF'),
                      ],
                    ),
                  ),
                ),
