    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            Text(data.city ?? data.stationName,
          ...
          children: [
            ...
            ProbabilityBarWidget(
              probabilities: {
                ...
                'MODERATE':
                    (data.capacityPercent.clamp(0, 60) > 30 ? 40.0 : 15.0),
                'SEVERE':
                    (data.capacityPercent.clamp(0, 90) > 60 ? 35.0 : 10.0),
        ...
        child: Row(
          ...
          children: [
            _InfoPill(
              label: 'Rainfall',
              value:
                  '${data.imdRainfallMm?.toStringAsFixed(1) ?? data.effectiveRainfallMm.toStringAsFixed(1)} mm',
              color: col,
            ),
            _InfoPill(
              label: 'Flow Rate',
