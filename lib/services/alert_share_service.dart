  ...
  AlertMessage buildMessage(FloodAlert alert) {
    ...
    switch (type) {
      case AlertType.levelAboveHfl:
        bodyEn =
            'Water level at $sta ($river, $dist) has exceeded HFL.\nCurrent: $cur m  |  HFL: $thr m\n\uD83D\uDFE5 IMMEDIATE EVACUATION required.';
        bodyHi =
            '$sta ($river, $dist) \u092E\u0947\u0902 \u091C\u0932\u0938\u094D\u0924\u0930 HFL \u0938\u0947 \u0909\u092A\u0930\u0964\n\u0935\u0930\u094D\u0924\u092E\u093E\u0928: $cur \u092E\u0940\u0964  |  HFL: $thr \u092E\u0940\u0964\n\uD83D\uDFE5 \u0924\u0924\u094D\u0915\u093E\u0932 \u0928\u093F\u0915\u093E\u0938\u0940 \u0906\u0935\u0936\u094D\u092F\u0915\u0964';
        break;
      case AlertType.levelAboveDanger:
        bodyEn =
            'Water level at $sta ($river, $dist) is ABOVE DANGER LEVEL.\nCurrent: $cur m  |  Danger: $thr m';
        bodyHi =
            '$sta ($river, $dist) \u092E\u0947\u0902 \u091C\u0932\u0938\u094D\u0924\u0930 \u0916\u0924\u0930\u0947 \u0915\u0940 \u0938\u0940\u092E\u093E \u0938\u0947 \u0909\u092A\u0930\u0964\n\u0935\u0930\u094D\u0924\u092E\u093E\u0928: $cur \u092E\u0940\u0964  |  \u0916\u0924\u0930\u093E: $thr \u092E\u0940\u0964';
        break;
      case AlertType.levelAboveWarning:
        bodyEn =
            'Water level at $sta ($river, $dist) crossed WARNING LEVEL.\nCurrent: $cur m  |  Warning: $thr m';
        bodyHi =
            '$sta ($river, $dist) \u092E\u0947\u0902 \u091C\u0932\u0938\u094D\u0924\u0930 \u091A\u0947\u0924\u093E\u0935\u0928\u0940 \u0938\u094D\u0924\u0930 \u092A\u093E\u0930\u0964\n\u0935\u0930\u094D\u0924\u092E\u093E\u0928: $cur \u092E\u0940\u0964  |  \u091A\u0947\u0924\u093E\u0935\u0928\u0940: $thr \u092E\u0940\u0964';
        break;
      case AlertType.rapidRise:
        bodyEn = 'RAPID RISE at $sta ($river, $dist). Rate: ${ror ?? "rapid"}';
        bodyHi =
            '$sta ($river, $dist) \u092E\u0947\u0902 \u0924\u0947\u091C \u0935\u0943\u0926\u094D\u0927\u093F\u0964 \u0926\u0930: ${ror ?? "\u0924\u0940\u0935\u094D\u0930"}';
        break;
      case AlertType.forecastDanger24h:
        bodyEn =
            'FORECAST: $sta danger level in 24h. Forecast: $cur m  |  Danger: $thr m';
        bodyHi =
            '\u092A\u0942\u0930\u094D\u0935\u093E\u0928\u0941\u092E\u093E\u0928: $sta 24 \u0918\u0902\u091F\u0947 \u092E\u0947\u0902 \u0916\u0924\u0930\u0947 \u0915\u0940 \u0938\u0940\u092E\u093E \u092A\u093E\u0930 \u0915\u0930 \u0938\u0915\u0924\u093E \u0939\u0948\u0964';
        break;
      case AlertType.forecastDanger48h:
        bodyEn =
            'FORECAST: $sta may reach danger in 48h. Forecast: $cur m  |  Danger: $thr m';
        bodyHi =
            '\u092A\u0942\u0930\u094D\u0935\u093E\u0928\u0941\u092E\u093E\u0928: $sta 48 \u0918\u0902\u091F\u0947 \u092E\u0947\u0902 \u0916\u0924\u0930\u0947 \u0915\u0940 \u0938\u0940\u092E\u093E \u092A\u093E\u0930 \u0915\u0930 \u0938\u0915\u0924\u093E \u0939\u0948\u0964';
        break;
      case AlertType.rainfallExtreme:
        bodyEn =
            'EXTREME RAINFALL near $sta ($dist). 24h: ${rain ?? ">100 mm"}';
        bodyHi =
            '$sta ($dist) \u0915\u0947 \u092A\u093E\u0938 \u0905\u0924\u094D\u092F\u0927\u093F\u0915 \u0935\u0930\u094D\u0937\u093E\u0964 24 \u0918\u0902\u091F\u0947: ${rain ?? ">100 \u092E\u092E\u0940"}';
        break;
      case AlertType.rainfallHeavy:
        bodyEn = 'HEAVY RAINFALL near $sta ($dist). 24h: ${rain ?? ">64.5 mm"}';
        bodyHi =
            '$sta ($dist) \u0915\u0947 \u092A\u093E\u0938 \u092D\u093E\u0930\u0940 \u0935\u0930\u094D\u0937\u093E\u0964 24 \u0918\u0902\u091F\u0947: ${rain ?? ">64.5 \u092E\u092E\u0940"}';
        break;
      case AlertType.upstreamCritical:
        bodyEn =
            'UPSTREAM CRITICAL: Multiple $river stations above danger. Downstream breach risk HIGH.';
        bodyHi =
            '\u0905\u092A\u0938\u094D\u091F\u094D\u0930\u0940\u092E \u0906\u092A\u093E\u0924: $river \u092A\u0930 \u0915\u0908 \u0938\u094D\u0925\u093E\u0928 \u0916\u0924\u0930\u0947 \u0915\u0940 \u0938\u0940\u092E\u093E \u0938\u0947 \u0909\u092A\u0930\u0964';
        break;
      case AlertType.multiRiverAlert:
        bodyEn =
            'MULTI-RIVER CRISIS: 3+ rivers above warning. State emergency.';
        bodyHi =
            '\u092C\u093F\u0939\u093E\u0930 \u092E\u0947\u0902 3+ \u0928\u0926\u093F\u092F\u093E\u0901 \u091A\u0947\u0924\u093E\u0935\u0928\u0940 \u0938\u094D\u0924\u0930 \u0938\u0947 \u0909\u092A\u0930\u0964 \u0930\u093E\u091C\u094D\u092F\u0935\u094D\u092F\u093E\u092A\u0940 \u0906\u092A\u093E\u0924\u0964';
        break;
      default:
